...
| fluentd-buffer-limit         | No       | Sets the number of events buffered in memory. The total memory limit is approximately this limt * the average log line length. Defaults to `1048576`.                                                   |
